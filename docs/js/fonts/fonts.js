(function() {
  ...
  window.iFonts = () => {
    if (!animations.length) {
      ...
      // });
      let a2 = anime.timeline({loop: false})
        .add({
          targets: '.ml13 .letter',
          translateY: [100,0],
          translateZ: 0,
      ...
      let a3 = anime.timeline({loop: false})
        .add({
          targets: '.ml11 .letter',
          opacity: null
        })
      ...
      let a4 = anime.timeline({loop: false})
        .add({
          targets: '.ml1 .letter',
          scale: [0.3,1],
          translateY: ["0.15em", "0.15em"], // centering the font
      ...
      let a5 = anime.timeline({loop: false})
        .add({
          targets: '.ml3 .letter',
          opacity: [0,1],
        ...
        //   loop: true
        // });
      animations.push(a1, a2, a3, a4, a5);
    }
  };
